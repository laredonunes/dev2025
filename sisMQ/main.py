...
from node_function import (processar_relatorio, enviar_notificacao, funcao_nao_encontrada,
                           processar_mensagem, gerar_perguntas_multipla_escolha, avaliar_progresso_jogo,
                           atualizar_contexto_historico,
                           )
...
ACTION_DISPATCHER = {
    ...
    "caminhos_sugeridos": gerar_perguntas_multipla_escolha,
    "avaliar_progresso_jogo": avaliar_progresso_jogo,
